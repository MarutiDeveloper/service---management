...
<div class="container">
    ...
    <form action="{{ route('admin.clients.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="position" id="position" class="form-control" placeholder="e.g. CEO, Manager" required>
        </div>

        <div class="mb-3">
            <label for="testimonial" class="form-label">Testimonial</label>
            <textarea name="testimonial" id="testimonial" rows="4" class="form-control" placeholder="Write testimonial..." required></textarea>
        </div>
