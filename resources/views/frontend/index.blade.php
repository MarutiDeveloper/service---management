        ...
        <div class="col-md-4">
          <div class="box" style="padding: 30px; border-radius: 10px; text-align: center; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
            <div class="img-box" style="margin-bottom: 15px;">
              <img src="{{ url('frontend-2/images/service/chatbot.png') }}" alt="Chatbot" style="max-width: 100px;">
            </div>
            <div class="detail-box">
...
<section class="why_section layout_padding">
  <div class="container">
    ...
    <div class="why_container">
      <div class="box">
        <div class="img-box">
          <img src="{{url('frontend-2/images/why/w2.png')}}" alt="">
        </div>
        <div class="detail-box">
          <h5>
      ...
      <div class="box">
        <div class="img-box">
          <img src="{{url('frontend-2/images/why/w3.png')}}" alt="">
        </div>
        <div class="detail-box">
          <h5>
            Automated Responses
      ...
      <div class="box">
        <div class="img-box">
          <img src="{{url('frontend-2/images/why/w1.png')}}" alt="">
        </div>
        <div class="detail-box">
          <h5>
      ...
      <div class="box">
        <div class="img-box">
          <img src="{{url('frontend-2/images/why/w4.png')}}" alt="">
        </div>
        <div class="detail-box">
          <h5>
    ...
    <div class="carousel-wrap ">
      <div class="owl-carousel client_owl-carousel">
        <div class="item">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend-2/images/client/client1.jpg')}}" alt="" class="box-img">
            </div>
            <div class="detail-box">
              <div class="client_id">
        ...
        <div class="item">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend-2/images/client/client2.jpg')}}" alt="" class="box-img">
            </div>
            <div class="detail-box">
              <div class="client_id">
                <div class="client_info">
        ...
        <div class="item">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend-2/images/client/client3.jpg')}}" alt="" class="box-img">
            </div>
            <div class="detail-box">
              <div class="client_id">
                <div class="client_info">
        ...
        <div class="item">
          <div class="box">
            <div class="img-box">
              <img src="{{url('frontend-2/images/client/client4.jpg')}}" alt="" class="box-img">
            </div>
            <div class="detail-box">
              <div class="client_id">
                <div class="client_info">
